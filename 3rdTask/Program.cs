...
//ان  الclass بياخد overheadcost من المومري ف بيبقي مكلف علي المومري بيزياده عن الstruct
//    struct مينفعش اورثه او اورث منه
//    الclass ينفع اورث منه او اورث بحد اقصي مره واحده بس
//    struct لو انا بعمل حاجه سريعه مش محتاجه تكلفه و فيها value data type
